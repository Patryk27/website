...
image::/resources/learning-to-fly-pt2/coding-propagate-1.svg[role="drawing w-70"]
...
image::/resources/learning-to-fly-pt2/coding-propagate-2.svg[role="drawing w-70"]
...
image::/resources/learning-to-fly-pt2/coding-propagate-3.svg[role=drawing]
...
image::/resources/learning-to-fly-pt2/coding-propagate-4.svg[role="drawing w-50"]
...
image::/resources/learning-to-fly-pt2/coding-propagate-5.svg[role=drawing, title="Ecstasy of Saint Ferris (upon seeing idiomatic code), colorized"]
...
[.source-title]
https://play.rust-lang.org/?version=stable&mode=debug&edition=2018&gist=945c2c2852ccbeb143ea569747038626[open in playground]
...
image::/resources/learning-to-fly-pt2/coding-new-1.svg[role="drawing w-30"]
...
image::/resources/learning-to-fly-pt2/coding-new-2.svg[role=drawing]
...
[.text-dim]
_(`add(1, 2)` will always return `3`, while `read("file.txt")` will return different strings depending on what given file happens to contain at the moment.)_
