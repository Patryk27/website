...
The entire solution leans on two nightly features: `auto_traits` & `negative_impls`, and while I wouldn't
recommend to use it in production code, it serves quite an educational purpose and was a fun piece of code to write:

[.source-title]
https://play.rust-lang.org/?version=nightly&mode=debug&edition=2018&gist=c9cbd4c7cc6810e2ed4e773437751181[open in playground]
