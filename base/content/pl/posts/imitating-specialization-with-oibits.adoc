...
Całość opiera się o dwa mechanizmy dostępne w nightly: `auto_traits` oraz `negative_impls`, i choć wolałbym
...
[.source-title]
https://play.rust-lang.org/?version=nightly&mode=debug&edition=2018&gist=c9cbd4c7cc6810e2ed4e773437751181[link do playgroundu]
