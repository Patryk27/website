...
Yes... ha ha ha... +++<u>yes</u>+++? ta-da? hey presto - we got... numbers galore?
...
Well, since we generally evaluate individuals by fitness scores, why don't we take a look theirs:
...
image::/resources/learning-to-fly-pt3/the-test-1.svg[role=drawing]
